...
print("First initials:", [name[0] for name in names])
print("Full initials:", [name.split()[0][0] + name.split()[1][0] for name in full_names])
print("A names:", [name for name in names if name.startswith('A')])
print("Joined names:", " ".join(sorted(names)))
print("Lowercase full names:", lowercase_full_names)
print("Numbers as integers:", numbers)
print("Numbers greater than 9:", numbers_greater_than_9)
print("Last names for long full names:", last_names_string)